...
@Serenity.Decorators.registerFormatter('_Ext.InlineMultipleImageFormatter')
export class InlineMultipleImageFormatter implements Serenity.Formatter, Serenity.IInitializeColumn {
