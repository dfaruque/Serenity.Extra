...
using SerExtraNet5.Common.Entities;
using System;
...
using System.Text;
using MyRow = SerExtraNet5.Administration.Entities.UserRow;

namespace SerExtraNet5.Administration.Repositories
{
    public partial class UserRepository : BaseRepository
    {
        public UserRepository(IRequestContext context) : base(context) { }
