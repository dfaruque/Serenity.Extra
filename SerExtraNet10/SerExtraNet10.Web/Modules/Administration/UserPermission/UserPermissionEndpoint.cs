using MyRepository = SerExtraNet10.Administration.Repositories.UserPermissionRepository;
using MyRow = SerExtraNet10.Administration.UserPermissionRow;

namespace SerExtraNet10.Administration.Endpoints;
