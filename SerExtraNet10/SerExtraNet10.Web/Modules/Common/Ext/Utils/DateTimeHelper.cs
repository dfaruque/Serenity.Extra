...
public static class DateTimeHelper
{
    ...
    /// <returns></returns>
    public static string ToDateFormat(this DateTime? inputValue, string format = "dd-MM-yyyy")
    {
    ...
    /// <param name="inputValue"></param>
    /// <returns></returns>
    public static string ToDateTimeFormat(this DateTime? inputValue, string format = "dd-MM-yyyy hh:mm tt")
    {
        string result = inputValue?.ToString(format ?? DateHelper.CurrentDateTimeFormat);
        return result;
    }
    public static string ToDateTimeFormat(this DateTime inputValue, string format = "dd-MM-yyyy hh:mm tt")
    {
