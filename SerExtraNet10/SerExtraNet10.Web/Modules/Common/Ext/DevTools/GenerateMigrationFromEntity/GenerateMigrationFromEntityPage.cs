...
namespace Ext.DevTools.Pages
{
    ...
    public class GenerateMigrationFromEntityController : Controller
    {
        ...
        {
            return View("~/Modules/Common/Ext/DevTools/GenerateMigrationFromEntity/GenerateMigrationFromEntityIndex.cshtml");
        }
        ...
        public ActionResult MigrationViewer()
        {
            ...
            return View("~/Modules/Common/Ext/DevTools/GenerateMigrationFromEntity/GenerateMigrationFromEntityMigrationViewer.cshtml", model);
        }
        ...
        public ActionResult GenerateSingleFile()
        {
            ...
            return View("~/Modules/Common/Ext/DevTools/GenerateMigrationFromEntity/GenerateMigrationFromEntitySuccessMsg.cshtml", model);
        }
