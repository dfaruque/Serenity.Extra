...
import { Editor, EditorOptions, H, keyCode } from "@serenity-is/sleekgrid";
...
export class CellEditByWidget extends BaseCellEdit {
    ...
    init() {
        const input = this._input = this._args.container.appendChild(H("input", {
            type: "text",
            class: 'editor-text slick-editor-text'
        }));
